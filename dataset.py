...
# database = {}
# image_list = os.listdir("../input/test-images/images/")
# for image in image_list:
#     if "test" not in image:
#         name = image.split(".")[0]
#         image = image_processing_for_database("../input/test-images/images/{}".format(image),cascade_face)
#         database[name] = img_to_encoding(image, FRmodel)

# dict_ = get_librispeech_spk_to_utts(myconfig.TEST_DATA_DIR)
# print(dict_)
# print("--------------------------------------")
# print(dict_.keys())
# print("---------------------------")
